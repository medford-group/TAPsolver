...
output_file_name = "ross_inert"	# "./FILENAME.csv"
...
Time_steps = 4100  				#time_step_value	# Number of time steps  
...
len_cat = 0#(1/20)*length_reac#2.54*(1/20)			###Length of the catalyst zone (cm) 
...
df1 = pd.read_csv('./toy_data/inertA.txt',sep=' ',header=None)
df2 = pd.read_csv('./ross_inert_folder/A.csv',header=None)
fig3, ax3 = plt.subplots()
ax3.plot(df1.iloc[:,0],df1.iloc[:,1])
ax3.plot(df2.iloc[:,0],df2.iloc[:,1])
plt.show()
