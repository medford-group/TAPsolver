...
def pulse_functions(reactions_n,number_of_inerts):
	...
	for k in range(0,molecules_in_gas_phase):
	#for k in range(0,1):
		#Fnew += "-intensConst['inten_"+str(k)+"']*b0Test2*v_d['v_"+str(k+1)+"']*dx"
		...
		Fnew += "-intensConst['inten_"+str(k)+"']*Inert_pulse_conc*b0Test2*exp(-(constantT - timeConst['sST_"+str(k)+"'])*(constantT - timeConst['sST_"+str(k)+"'])/(4*0.00000000001))*v_d['v_"+str(k+1)+"']*dx"
		if k < molecules_in_gas_phase-1:
			Fnew += ' + '
	...
	for k in range(0,int(number_of_inerts)):
		#Fnew += "-intensConst['inten_"+str(molecules_in_gas_phase+k)+"']*b0Test2*v_d['v_"+str(len(reactants)+1+k)+"']*dx"
		...
		Fnew += "-intensConst['inten_"+str(molecules_in_gas_phase+k)+"']*Inert_pulse_conc*b0Test2*exp(-(constantT - timeConst['sST_"+str(molecules_in_gas_phase+k)+"'])*(constantT - timeConst['sST_"+str(molecules_in_gas_phase+k)+"'])/(4*0.00000000001))*v_d['v_"+str(len(reactants)+1+k)+"']*dx"
