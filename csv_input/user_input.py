...
from python_RRM import R_RRM_func, petal_plots_RRM, MKM_graphs, petal_plots_exp, jacobian_visual

user_data = pd.read_csv('./input_file.csv',header=None)

###### Read in the csv_input file ######
...
def base_run():
	...
	### Read in the information related to the elementary reactions ###
	kinetic_parameters = {}
	...
	### Call on simulator and feed in the two previous dictionaries ###
