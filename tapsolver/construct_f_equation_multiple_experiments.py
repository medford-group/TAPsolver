...
def construct_f_equation_multiple_experiments(TAPobject_data: TAPobject):
	...
	def make_g(elementary_process,direction,scale_magnitude):
		...
		if direction == 'f':
			return "((standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(temperature_number)+"]*(1/TAPobject_data.parameter_scale**("+str(scale_magnitude)+")))/(standard_parameters['h']))*exp(-TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.Ga/(standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(temperature_number)+"]))"
		else:
			return "((standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(temperature_number)+"]*(1/TAPobject_data.parameter_scale**("+str(scale_magnitude)+")))/(standard_parameters['h']))*exp(-(TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.Ga - TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.dG)/(standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(temperature_number)+"]))"
