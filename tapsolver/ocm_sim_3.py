...
new_reactor = reactor()
# 1.14e-05 m2
new_reactor.zone_lengths = {0:1.8675,1:0.2,2:1.8675} #cm
new_reactor.zone_voids = {0:0.4,1:0.4,2:0.4} # -
new_reactor.reactor_radius = 0.19 #cm
# 0.002 m2/s
#0.00267 m2/s
new_reactor_species = reactor_species()
new_reactor_species.inert_diffusion = 27 #cm2/s
new_reactor_species.catalyst_diffusion = 27#cm2/s
new_reactor_species.reference_temperature = 700#K
new_reactor_species.reference_mass = 30.88#amu
new_reactor_species.temperature = 700#K
new_reactor_species.advection = 0

O182 = define_gas()
O182.mass = 36
O182.intensity = 0.092
O182.delay = 0
O182.sigma = 0.02
O182.noise = 0.0
...
new_mechanism.elementary_processes[1] = elementary_process('O162 + * <-> O162*')
new_mechanism.elementary_processes[2] = elementary_process('O18O16 + * <-> O18O16*')
new_mechanism.elementary_processes[3] = elementary_process('O182* + O16* <-> O18O16* + O18*')
new_mechanism.elementary_processes[4] = elementary_process('O18O16* + O16* <-> O18O16* + O18*')


new_mechanism.kinetic_links = {0:0.001,1:0.001,2:0.001}
...
new_mechanism.elementary_processes[1].backward.link = 1
...
new_mechanism.elementary_processes[3].backward.link = 2
new_mechanism.elementary_processes[4].forward.link = 2
new_mechanism.elementary_processes[4].backward.link = 2
...
OCM_tapobject.optimize = True
OCM_tapobject.parameters_of_interest = ['TAPobject_data.mechanism.kinetic_links[0]','TAPobject_data.mechanism.kinetic_links[1]','TAPobject_data.mechanism.kinetic_links[2]']
