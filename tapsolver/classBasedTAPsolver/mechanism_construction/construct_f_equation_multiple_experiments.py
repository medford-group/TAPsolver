...
def construct_f_equation_multiple_experiments(TAPobject_data: TAPobject):
	...
	def make_g(elementary_process,direction):
		...
		if direction == 'f':
			return "standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(temperature_number)+"]/standard_parameters['h']*exp(-TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.Ga['value']/(standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(TAPobject_data.reactor_species.gasses[species_name].temperature_used)+"]))"
		else:
			return "standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(temperature_number)+"]/standard_parameters['h']*exp(-(TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.Ga['value'] - TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.dG['value'])/(standard_parameters['kbt']*TAPobject_data.reactor_species.temperature["+str(TAPobject_data.reactor_species.gasses[species_name].temperature_used)+"]))"
	...
	def make_arr(elementary_process,direction):
		...
		if direction == 'f':
			return "TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.Ao['value']*exp(-TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].forward.Ea['value']/(standard_parameters['Rgas']*TAPobject_data.reactor_species.temperature["+str(TAPobject_data.reactor_species.gasses[species_name].temperature_used)+"]))"
		else:
			return "TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].backward.Ao['value']*exp(-TAPobject_data.mechanism.elementary_processes["+str(elementary_process)+"].backward.Ea['value']/(standard_parameters['Rgas']*TAPobject_data.reactor_species.temperature["+str(TAPobject_data.reactor_species.gasses[species_name].temperature_used)+"]))"
