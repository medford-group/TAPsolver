...
for k_cool in range(0,len(mesh_size_list)):
#for time_step_value in time_step_list:
	time_step_value = 600
	print("CURRENT VALUE: "+str(mesh_size_list[k_cool]))
	...
	mesh_size = mesh_size_list[k_cool]#mesh_size_list[k_cool] #280	# Want to test and store all of these
	T = 400 
