...
#run_tapsolver(timeFunc=4,store_thin_func=False,inputFile='./input_file_thermoConst.csv',pulseNumber=1,input_form='new')
#fit_parameters(0.25,inputFile='./input_file_thermoConst.csv',input_form='new')
